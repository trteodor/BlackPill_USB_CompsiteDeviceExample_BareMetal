...
define PrintActualAppInfo
ExecuteCompilation_ASM_Files += $(1) 
$(1):
$(1):
	@echo ________________________________________________________________________________________________________
	@echo  \ \ \ \ \ \ \ \ \ \ \ Compilation Start Project: \ $(1)
	@echo ________________________________________________________________________________________________________
endef


# $(eval $(call PrintActualAppInfo,$(1)))
#SCRIPT START
################################################################################################
...
ActualAppName = $$(addprefix \ ,$(1))

$$(eval $$(call PrintActualAppInfo,$$(ActualAppName)))
...
$(HelperVariable)/$(1): $$(OBJECTS) Makefile
	...
	@echo ________________________________________________________________________________________________________
	@echo  \ \ \ \ \ Compilation Succesfull Project: \ \   $$(@F)
	@echo ________________________________________________________________________________________________________
	@echo
	@echo
