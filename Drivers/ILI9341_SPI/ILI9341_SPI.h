...
// Pin operation
//
#define ILI9341_CS_LOW GPIO_PinReset(TFT_CS_GPIO_Port, GPIO_PIN_15);
#define ILI9341_CS_HIGH GPIO_PinSet(TFT_CS_GPIO_Port, GPIO_PIN_15);

#define ILI9341_DC_LOW GPIO_PinReset(TFT_DC_GPIO_Port, TFT_DC_Pin);
#define ILI9341_DC_HIGH GPIO_PinSet(TFT_DC_GPIO_Port, TFT_DC_Pin);

#define ILI9341_RST_LOW GPIO_PinReset(TFT_RST_GPIO_Port, TFT_RST_Pin);
#define ILI9341_RST_HIGH GPIO_PinSet(TFT_RST_GPIO_Port, TFT_RST_Pin);
